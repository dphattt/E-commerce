...
export function HomeBestsellersCarousel({
  ...
  return (
    <section className="bg-store-paper px-4 py-16 text-store-ink-strong sm:px-8 lg:px-12 2xl:px-16">
        ...
        <div className="overflow-hidden">
          <CarouselContent className="-ml-2">
            {products.map((product, index) => (
              <CarouselItem
                key={product._id}
                className="basis-[82%] pl-2 sm:basis-1/2 md:basis-1/3 lg:basis-1/5 2xl:basis-1/6"
              >
                <BestsellerCard
                  product={product}
                  index={index}
