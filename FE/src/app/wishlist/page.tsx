...
function WishlistIllustration() {
  return (
    <div className="relative mx-auto flex size-[220px] items-center justify-center">
      ...
      {/* Sparkles */}
      <svg className="absolute inset-0 size-full" viewBox="0 0 220 220" fill="none" aria-hidden>
      ...
      <div
        className="absolute left-[38px] top-[55px] flex size-[80px] -rotate-6 flex-col overflow-hidden rounded-lg bg-zinc-700 shadow-lg"
      >
      ...
      <div
        className="absolute left-[100px] top-[50px] flex size-[80px] rotate-6 flex-col overflow-hidden rounded-lg bg-zinc-600 shadow-lg"
      >
